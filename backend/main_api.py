...
from backend.routers import auth, borradores, configuracion, creditos, gastos, insumos, mesas, nomina, preparaciones, productos, reportes, turnos, usuarios, ventas
